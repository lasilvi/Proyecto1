"""
Django settings for proyectoactas project.
...
SECRET_KEY = 'django-insecure-949&potmlcb&9)aa3o87y74z8fmj_t3)0&_=1nj(%2it)qfzct'
...
WSGI_APPLICATION = 'proyectoactas.wsgi.application'
...
EMAIL_PORT = 587 # Ejemplo: 587 para SMTP de Gmail
